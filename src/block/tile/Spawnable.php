...
abstract class Spawnable extends Tile{
	...
	public function isDirty() : bool{
		return count($this->spawnCompoundCache) === 0;
	}
	...
	final public function getSerializedSpawnCompound(TypeConverter $typeConverter) : CacheableNbt{
		$cacheKey = spl_object_id($typeConverter);
		if(!isset($this->spawnCompoundCache[$cacheKey])){
			$this->spawnCompoundCache[$cacheKey] = new CacheableNbt($this->getSpawnCompound($typeConverter));
		}

		return $this->spawnCompoundCache[$cacheKey];
	}
