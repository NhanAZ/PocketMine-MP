...
- For #3974, targeted `WorldManagerTest`/`WorldTest` (6 tests, 33 assertions), full PHPUnit (256 tests, 72,698 assertions), touched-file and full PHPStan, syntax, code generation, translation validation, generated-file collision, JSON, and whitespace checks passed locally. PHP-CS-Fixer is unavailable locally and CI is pending.
