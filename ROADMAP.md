...
- The #5603 fence-family regression passed targeted and full PHPUnit, full PHPStan, code generation, translation validation, generated-file collision, JSON, syntax, and whitespace checks; local PHP-CS-Fixer 3.75 remains unavailable, so CI is the style gate.
...
- Fork CI health is the top active gate; the latest checked stable CI and Docker runs through commit `3747f8fbb` are green.
