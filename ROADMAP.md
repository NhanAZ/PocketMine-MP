...
- The #6714 projectile-close regression passed targeted and full PHPUnit, touched-file and full PHPStan, code generation, translation validation, generated-file collision, JSON, syntax, and whitespace checks. PHP-CS-Fixer is not installed locally; CI remains responsible for style.
...
- Fork CI health is the top active gate; stable CI and Docker are green through implementation commit `9f43f9497`.
...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - 2026-07-03: implemented #6714 with block-hit and entity-hit event-close coverage (2 tests, 8 assertions), full PHPUnit (241 tests, 72,633 assertions), full PHPStan, code generation, translation validation, generated-file collision, JSON, syntax, and whitespace checks. Local PHP-CS-Fixer is unavailable; watch CI style.
