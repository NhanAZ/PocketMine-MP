...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - Next unreviewed shortlist candidate: #6712, "Bad saved hunger values crash the server". Read the original report and inspect saved-player validation before deciding whether to implement or defer it.
