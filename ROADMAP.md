...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - Next unreviewed shortlist candidate: #6714, "Crash when plugins close() projectiles during ProjectileHit(Block|Entity)Event". Read the original crash evidence and inspect projectile event lifetime handling before changing it.
