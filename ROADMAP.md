...
- Fork CI health is the top active gate; stable CI and Docker are green through status commit `fa4886ed8`.
...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - Next unreviewed shortlist candidate: #5638, "PlayerAuthInputPacket: Add timings for transaction handling, movement processing etc". Read the original issue and inspect packet-handling timings before changing it.
