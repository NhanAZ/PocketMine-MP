...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - Next unreviewed shortlist candidate: #7035, "Protocol 944 LevelDB unsupported 'world'". Treat it as world-data/protocol-sensitive and require a reproducible affected world before changing loaders.
