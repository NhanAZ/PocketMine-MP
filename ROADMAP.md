...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - Next unreviewed shortlist candidate: #5463, "Update Checker incorrectly detects the server build". Read the original issue and current fork update-checker behaviour before deciding whether to implement or defer it.
