...
- Fork CI health is the top active gate; stable CI and Docker are green through style follow-up commit `9270fb248`.
...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - Next unreviewed shortlist candidate: #5385, "You can no longer interact with the world after rejoining while being in the death screen". Read the original discussion and inspect death/respawn interaction handling before changing it.
