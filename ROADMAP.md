...
- Fork CI health is the top active gate; stable CI and Docker are green through #5638 implementation commit `13fba9671`.
...
- [x] Preserve source links and authorship; do not copy whole discussions.
  ...
  - Next unreviewed shortlist candidate: #5064, "Add a configuration option to disable listing players in GS4 query responses". Read the original issue and inspect Query response compatibility before changing it.
